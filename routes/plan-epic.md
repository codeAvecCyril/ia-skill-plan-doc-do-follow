...
**Purpose**: create the epic PRD and feature tracking
...
5. Generate `epic-prd.md` from `templates/epic-prd.md`; every requirement a complete sentence a stakeholder can validate (Invariant 6)
