...
2. Auto-verify the mechanical items (completeness, testable criteria, valid references, consistency with parent docs); collapse to one summary line. Fix trivial gaps directly
