...
2. Auto-verify the mechanical items (stories testable, criteria measurable, edge cases listed, out-of-scope defined, entry point registered in `docs/ui-map.md` for UI features) and collapse them to one summary line. Fix trivial gaps directly.
