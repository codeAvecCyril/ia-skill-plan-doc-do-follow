...
3. Rewrite each feature row in its `epic-status.md`, then each epic row, the Progress section, and the pie chart in `docs/project-status.md` (no changelog entry — changelogs record milestones only)
